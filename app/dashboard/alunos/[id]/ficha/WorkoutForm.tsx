...
export default function WorkoutForm({
  ...
  const handleExerciseCreated = (newEx: {
    id: string;
    name: string;
    muscleGroup: string;
  }) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6 font-sans">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
                      <div className="flex-3 sm:flex-3">
                        <div className="mb-2 flex items-center justify-between">
                          ...
                          <button
                            type="button"
                            onClick={() => setModalTarget({ sIndex, eIndex })} // Guarda a posição exata!
        ...
        <div className="sticky bottom-0 z-10 -mx-4 mt-8 flex gap-3 border-t border-gray-800 bg-black/90 p-4 backdrop-blur-md sm:static sm:mx-0 sm:bg-transparent sm:p-0 sm:backdrop-blur-none">
          <button
            ...
            className="flex-1 cursor-pointer rounded-xl border-2 border-gray-700 bg-gray-900 p-4 text-sm font-bold uppercase tracking-widest text-gray-300 transition-all hover:bg-gray-500 hover:text-white active:scale-95"
          >
            Cancelar
          </button>
